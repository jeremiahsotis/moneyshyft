...
| apps/admin-api/src/routes/api/v1/connectshyft.ts        | route         | CONNECTSHYFT                  | unmounted_in_admin       | connectshyft-api                           | dead_stale           | safe_delete_after_convergence | retained in repo but admin-api does not mount it  |
...
| apps/admin-api/src/routes/api/v1/route.ts               | route mirror  | ROUTESHYFT                    | unmounted_in_admin       | none during current remediation            | dead_stale           | safe_delete_after_convergence | stale Admin RouteShyft mirror; not an alternate owner |
| apps/admin-api/src/routes/api/v1/route-bridge.ts        | route mirror  | ROUTESHYFT                    | unmounted_in_admin       | none during current remediation            | dead_stale           | safe_delete_after_convergence | stale Admin RouteShyft bridge mirror; not an alternate owner |
| apps/admin-api/src/modules/route                        | module mirror | ROUTESHYFT                    | unmounted_in_admin       | none during current remediation            | dead_stale           | safe_delete_after_convergence | stale Admin RouteShyft module mirror; cleanup deferred |
