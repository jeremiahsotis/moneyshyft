...
// Story b.2 neighbor profile route/view is not implemented yet in frontend router/views.
// Keep these as executable-ready journey contracts once UI is available.
test.describe(
