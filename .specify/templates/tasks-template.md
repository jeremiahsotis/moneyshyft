...
- [ ] T004 Capture lane and routing ownership matrix for all affected endpoints
...
- [ ] T008 Enforce delegation of `/api/v1/auth/*` and `/api/v1/platform/admin/*` to `admin-api`
- [ ] T009 Ensure lane API routes resolve only to lane-owned services
- [ ] T010 Verify API containers bind to localhost-only ports in deployment config
- [ ] T011 Validate shared Postgres connectivity and migration ownership constraints
...
- [ ] TXXX Validate Admin/MoneyShyft/ConnectShyft deployment and route delegation
- [ ] TXXX Verify reproducible deployment using runbook without manual adjustments
