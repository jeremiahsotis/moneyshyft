...
const usage = () => {
  console.log(`MoneyShyft WP cutover rehearsal

Usage:
  node scripts/moneyshyft/wp-cutover/rehearse-route-cutover.mjs --input <wp-export.json> [options]
  node scripts/moneyshyft/wp-cutover/rehearse-route-cutover.mjs --reconcile-only [options]
