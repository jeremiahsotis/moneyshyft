  ...
  <div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-50 to-primary-100 px-4">
    <div class="max-w-md w-full space-y-8 bg-white p-8 rounded-2xl shadow-xl">
      <div class="text-center">
        <h1 class="text-4xl font-bold text-gray-900">Shyft Admin</h1>
        <p class="mt-2 text-sm text-gray-600">Centralized tenant and user administration</p>
      </div>
      ...
      <form @submit.prevent="handleLogin" class="mt-8 space-y-6">
        ...
        <div class="text-center">
          <router-link to="/auth/password/forgot" class="text-sm text-primary-600 hover:text-primary-700">
            Forgot password?
          </router-link>
        </div>
      </form>
