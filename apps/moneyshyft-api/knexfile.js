...
const localProductionMigrationDirectory = path.join(__dirname, 'dist', 'migrations');
...
blockLaneProdMigrationExecution('money-api');
...
module.exports = {
  ...
  production: {
    ...
    migrations: {
      tableName: 'knex_migrations',
      directory: localProductionMigrationDirectory,
      extension: 'js'
    },
    seeds: {
