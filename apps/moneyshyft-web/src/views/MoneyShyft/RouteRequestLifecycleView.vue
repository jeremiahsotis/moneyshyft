...
<template>
  <main class="mx-auto max-w-5xl px-4 py-8">
    ...
    <section class="mb-6 rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
      ...
      <p data-testid="moneyshyft-request-terminal-status" class="mt-2 text-lg font-medium text-slate-900">
        {{ terminalStatusLabel }}
      </p>

      <div class="mt-4" data-testid="moneyshyft-request-reconciliation-actions">
    ...
    <section class="rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
      <button
        ...
        data-testid="moneyshyft-request-finalize-submit"
        :disabled="submitting"
      ...
      <p class="mt-4 text-sm font-medium text-slate-800" data-testid="moneyshyft-request-refusal-banner">
        {{ refusalBanner }}
      </p>

      <p class="mt-2 text-sm text-slate-700" data-testid="moneyshyft-request-refusal-code">
        {{ refusalCode }}
      </p>
      ...
      <pre
        ...
        data-testid="moneyshyft-request-lifecycle-details"
