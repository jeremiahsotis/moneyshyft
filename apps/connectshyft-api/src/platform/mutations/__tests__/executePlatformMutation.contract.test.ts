...
const FIXTURE_SCHEMA = 'platform_mutation_contract_connectshyft';
const TEST_TENANT_ID = '77777777-7777-4777-8777-777777777777';
const TEST_ACTOR_ID = '88888888-8888-4888-8888-888888888888';
const SUCCESS_EVENT_NAME = 'kernel.mutation.accepted.connectshyft-contract';
const FAIL_EVENT_NAME = 'kernel.mutation.force-outbox-fail.connectshyft-contract';
const OUTBOX_FAILURE_FUNCTION = 'raise_outbox_fail_connectshyft_contract';
const OUTBOX_FAILURE_TRIGGER = 'trg_outbox_fail_connectshyft_contract';
...
describeIfDb('executePlatformMutation (postgres contract)', () => {
  ...
  beforeAll(async () => {
    ...
    await db.withSchema('platform').table('tenants').insert({
      id: TEST_TENANT_ID,
      name: 'ConnectShyft Contract Tenant',
      status: 'active',
    }).onConflict('id').ignore();

    await db('users').insert({
      id: TEST_ACTOR_ID,
      email: 'connectshyft-contract@example.com',
