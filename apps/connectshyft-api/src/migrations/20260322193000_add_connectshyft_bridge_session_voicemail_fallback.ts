...
const BRIDGE_LEG_PROVIDER_CALL_CONTROL_INDEX = 'connectshyft_cs_bridge_legs_provider_call_control_idx'
...
export async function down(knex: Knex): Promise<void> {
  await knex.raw(`DROP INDEX IF EXISTS ${CONNECTSHYFT_SCHEMA}.${BRIDGE_LEG_PROVIDER_CALL_CONTROL_INDEX}`)
