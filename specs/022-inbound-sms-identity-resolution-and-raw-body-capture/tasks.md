...
- [ ] T019 [P] [US2] Add route coverage in `/Users/jeremiahotis/projects/connectshyft/apps/connectshyft-api/src/routes/api/v1/__tests__/connectshyft.identity-match.test.ts` to preserve explicit-reference deleted-neighbor filtering and ambiguity semantics after lifecycle-state support is surfaced
